            ...
            <div class="joms-focus__actions__wrapper">
                ...
                <div class="joms-focus__actions--desktop">
                    <?php if ( !$isMine ) { ?>
						...
						<!-- yesinternet : Donate-->
						<?php	$donorwizUser=new DonorwizUser($profile->id);?>
						...
						<a href="<?php echo JRoute::_('donate/?beneficiary_id='.$profile->id);?>" class="joms-focus__button--add">
        ...
        <ul class="joms-dropdown">
            <?php if ($isMine || COwnerHelper::isCommunityAdmin()) { ?>
                ...
                <?php if ($isMine) { ?>
                    ...
                    <li><a href="javascript:"><?php echo JText::_('COM_COMMUNITY_VIDEOS_REMOVE_PROFILE_VIDEO'); ?></a></li>
                    <?php } ?>
