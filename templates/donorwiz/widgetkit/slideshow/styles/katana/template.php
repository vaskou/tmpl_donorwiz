...
<div id="slideshow-<?php echo $widget_id; ?>" class="wk-slideshow wk-slideshow-katana" data-widgetkit="slideshow" data-options='<?php echo json_encode($settings); ?>'>
	...
	<div>
		...
		<div class="">
			<?php if (isset($settings['buttons']) && $settings['buttons']) : ?><div class="next uk-text-center uk-border-circle uk-hidden-small"><i class="uk-icon-long-arrow-right uk-icon-large uk-text-contrast uk-text-center"></i></div><div class="prev uk-text-center uk-border-circle uk-hidden-small"><i class="uk-icon-long-arrow-left uk-icon-large uk-text-contrast uk-text-center"></i></div><?php endif; ?>
			<div class="caption uk-width-1-1"></div>
