...
// render template
echo '<div class="uk-text-center uk-margin uk-animation-fade uk-animation-'.rand(1, 5).'">';
echo $warp['template']->render('blogarticle', $args);
echo '<div class="uk-panel-blank">';
echo '<a href="'.$urls->urla.'" '.$target.'>';
echo $urls->urlatext;
echo '</a>';
echo '</div>';
echo '</div>';